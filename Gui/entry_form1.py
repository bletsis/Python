...
lbl_first_name = tk.Label(frm_form, text="First Name:")
ent_first_name = tk.Entry(frm_form, width=50)
...
ent_last_name = tk.Entry(frm_form, width=50)
...
lbl_address1 = tk.Label(frm_form, text="Address Line 1:")
ent_address1 = tk.Entry(frm_form, width=50)
...
lbl_address2 = tk.Label(frm_form, text="Address Line 2:")
ent_address2 = tk.Entry(frm_form, width=50)
...
lbl_city = tk.Label(frm_form, text="City:")
ent_city = tk.Entry(frm_form, width=50)
...
lbl_state = tk.Label(frm_form, text="State/Province:")
ent_state = tk.Entry(frm_form, width=50)
...
lbl_postal_code = tk.Label(frm_form, text="Postal Code:")
ent_postal_code = tk.Entry(frm_form, width=50)
...
lbl_country = tk.Label(frm_form, text="Country:")
ent_country = tk.Entry(frm_form, width=50)
...
##############################################
#                                            #
#    Ίδιο με το παραπάνω αλλά πιο συμπαγές   #
#                                            #
##############################################
